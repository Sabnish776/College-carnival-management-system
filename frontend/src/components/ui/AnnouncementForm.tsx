      ...
      >
        <div className="bg-zinc-900 p-8 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold tracking-tight">New Announcement</h2>
              <p className="text-white/50 text-xs uppercase tracking-widest font-bold">Broadcast to all students</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl py-3 px-4 text-sm outline-none focus:ring-2 focus:ring-zinc-900/5 focus:border-zinc-900 transition-all min-h-[120px] resize-none"
